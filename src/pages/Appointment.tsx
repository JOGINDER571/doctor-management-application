  ...
  const getAvailableSlots = () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        timeSlots.push({
          datetime: new Date(currentDate), // fixed typo: `datatime` → `datetime`
          time: formattedTime,
        });
    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-82 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button className="my-5 font-light text-xl text-white bg-primary py-2 px-5 rounded-full cursor-pointer hover:scale-105 transition-all duration-300">
            Book an appointment
          </button>
        </div>
